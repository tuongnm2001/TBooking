...
const getDetailUpdelBlogById = (inputId) => {
    return axios.get(`/api/get-updel-blog-by-id?id=${inputId}`)
}

const deleteBlog = (inputId) => {
    return axios.delete(`/api/delete-blog`, { data: { id: inputId } })
}
...
export {
    ...
    getDetailUpdelBlogById, deleteBlog
}